...
function Harmonic:onLoadGraph(channelCount)
    ...
    f1Bump:hardSet("Center", 0.063) -- distributing centers of bumpmaps
    ...
    f2Bump:hardSet("Center", 0.188) -- distributing centers of bumpmaps
    ...
    f3Bump:hardSet("Center", 0.313) -- distributing centers of bumpmaps
    ...
    f4Bump:hardSet("Center", 0.438)-- distributing centers of bumpmaps
    ...
    f5Bump:hardSet("Center", 0.563) -- distributing centers of bumpmaps
    ...
    f6Bump:hardSet("Center", 0.688) -- distributing centers of bumpmaps
    ...
    f7Bump:hardSet("Center", 0.813) -- distributing centers of bumpmaps
    ...
    f8Bump:hardSet("Center", 0.938) -- distributing centers of bumpmaps
    ...
    local fPlusOne = self:addObject("fPlusOne", app.Constant())
    fPlusOne:hardSet("Value", 1)
    ...
    connect(fPlusOne, "Out", f1Bias, "Right")
    ...
    connect(fPlusOne, "Out", f2Bias, "Right")
    ...
    connect(fPlusOne, "Out", f3Bias, "Right")
    ...
    connect(fPlusOne, "Out", f4Bias, "Right")
    ...
    connect(fPlusOne, "Out", f5Bias, "Right")
    ...
    connect(fPlusOne, "Out", f6Bias, "Right")
    ...
    connect(fPlusOne, "Out", f7Bias, "Right")
    ...
    connect(fPlusOne, "Out", f8Bias, "Right")
